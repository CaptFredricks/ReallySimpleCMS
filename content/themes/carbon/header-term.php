...
<html lang="en">
	<head>
		<title><?php $rs_term->getTermName(); ?> &rtrif; <?php getSetting('site_title'); ?></title>
		<meta charset="UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="theme-color" content="<?php getSetting('theme_color'); ?>">
		<meta name="description" content="">
		<meta property="og:title" content="<?php $rs_term->getTermName(); ?>">
		<meta property="og:type" content="website">
		<meta property="og:url" content="<?php $rs_term->getTermUrl(); ?>">
