...
function requireFile(string $filepath, bool $once = true): void {
	...
	global $rs_query, $rs_session, $rs_register, $rs_ad_register, $rs_update, $rs_error, $rs_theme_path,
		$rs_admin_pages, $rs_modules, $rs_themes, $rs_admin_themes, $rs_post_types, $rs_taxonomies;
