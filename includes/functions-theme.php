...
/**
 * Alias for the Post class' getPostId method.
 * @since 1.2.8-beta
 *
 * @see Post::getPostId()
 * @return int
...
/**
 * Alias for the Post class' getPostTitle method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostAuthor method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostDate method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostModDate method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostContent method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostStatus method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostSlug method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostParent method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostType method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostFeaturedImage method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostMeta method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostTerms method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostComments method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Post class' getPostUrl method.
 * @since 1.2.8-beta
 *
 * @see Post::getPostUrl()
 * @return string
...
/**
 * Alias for the Post class' postHasFeaturedImage method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Term class' getTermId method.
 * @since 1.2.8-beta
 *
 * @see Term::getTermId()
 * @return int
...
/**
 * Alias for the Term class' getTermName method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Term class' getTermSlug method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Term class' getTermTaxonomy method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Term class' getTermParent method.
 * @since 1.2.8-beta
 *
...
/**
 * Alias for the Term class' getTermUrl method.
 * @since 1.2.8-beta
 *
 * @see Term::getTermUrl()
 * @return string
 ...
 * @return array
 */
function getTermPosts(mixed $_term = null, string $order_by = 'created', string $order = 'DESC', int $limit = 0): array {
	global $rs_query;
...
/**
 * Alias for the Query class' select method.
 * @since 1.3.8-beta
 *
 * @see Query::select()
...
function querySelect(string|array $table, string|array $cols = '*', array $where = array(), array $args = array()): int|array {
	...
	return $rs_query->select($table, $cols, $where, $args);
}

/**
 * Alias for the Query class' selectRow method.
 * @since 1.3.8-beta
 *
 * @see Query::selectRow()
 * @param string|array $table -- The table name and optionally, table prefix.
...
function querySelectRow(string|array $table, string|array $cols = '*', array $where = array(), array $args = array()): int|array {
	...
	return $rs_query->selectRow($table, $cols, $where, $args);
}

/**
 * Alias for the Query class' selectField method.
 * @since 1.3.8-beta
 *
...
/**
 * Alias for the Query class' insert method.
 * @since 1.3.8-beta
 *
 * @see Query::insert()
 * @param string|array $table -- The table name and optionally, table prefix.
...
/**
 * Alias for the Query class' update method.
 * @since 1.3.8-beta
 *
 * @see Query::update()
 * @param string|array $table -- The table name and optionally, table prefix.
...
/**
 * Alias for the Query class' delete method.
 * @since 1.3.8-beta
 *
 * @see Query::delete()
 * @param string|array $table -- The table name and optionally, table prefix.
