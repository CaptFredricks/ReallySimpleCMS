...
function runPostTypesRegister(): void {
	...
	registerPostType('page', array(
		...
		'menu_icon' => array('copy', 'regular') # backward compat
	));
	...
	registerPostType('post', array(
		...
		'menu_link' => 'posts.php', # backward compat
		'menu_icon' => 'newspaper', # backward compat
		'comments' => true,
		'taxonomies' => array(
			'category'
		)
	...
	registerPostType('media', array(
		...
		'menu_link' => 'media.php', # backward compat
		'menu_icon' => 'images' # backward compat
	));
	...
	registerPostType('widget', array(
		...
		'menu_link' => 'widgets.php' # backward compat
	));
}
