...
#define('RS_VERSION', '1.4.0-beta_snap-04_dev');
define('RS_VERSION', '1.4.0-beta_snap-04');
...
define('GLOBAL_FUNC', RS_GLOBAL_FUNC); // deprecated
...
define('RS_FUNC', RS_FRONT_FUNC); // deprecated
